...
public class FormUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/rotbak31/gambar/Selamat Datang.jpg"))); // NOI18N
        jLabel9.setText("jLabel9");
        jLabel9.setPreferredSize(new java.awt.Dimension(600, 500));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Connection con = Koneksi.getConnection();
            String NamaFile = "/com/rotbak31/report/struk_bayar.jasper";
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        Connection con = Koneksi.getConnection();
            String NamaFile = "/com/rotbak31/report/laporan_penjualan.jasper";
            HashMap hash = new HashMap();
        try {
